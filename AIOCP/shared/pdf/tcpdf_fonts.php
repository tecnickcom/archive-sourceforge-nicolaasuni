...
// -------------------------------------------------------------------
//
// Description : Unicode data and font methods for TCPDF library.
//
//============================================================+
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	...
	public static function utf8StrRev($str, $setbom=false, $forcertl=false, $isunicode=true, &$currentfont) {
		return self::utf8StrArrRev(TCPDF_FONTS::UTF8StringToArray($str, $currentfont), $str, $setbom, $forcertl, $isunicode, $currentfont);
	}
	...
	public static function utf8StrArrRev($arr, $str='', $setbom=false, $forcertl=false, $isunicode=true, &$currentfont) {
		return self::arrUTF8ToUTF16BE(TCPDF_FONTS::utf8Bidi($arr, $str, $forcertl, $isunicode, $currentfont), $setbom);
	}
