...
//
// Description : Functions for show Menu using JWTM applet
//
//
// Author: Nicola Asuni
//
...
*/
function F_show_jwtm_menu($menu_name, $forcetext=false, $externalfile=true) {
	...
	$menucode .= " archive=\"jwtm.jar\"";
	$menucode .= " code=\"com.tecnick.jwtm.Jwtm.class\"";
	...
	$menucode .= "<param name=\"menu_direction\" value=\"".$menu_direction."\" />\n";
	...
	$menucode .= "<param name=\"background_img\" value=\"\" />\n";
	$menucode .= "<param name=\"background_img_pos\" value=\"TILE\" />\n";
	
	$menucode .= "<param name=\"img_node_off\" value=\"".K_PATH_IMAGES_ICONS_CLIENT."node_close.gif\" />\n";
	$menucode .= "<param name=\"img_node_over\" value=\"".K_PATH_IMAGES_ICONS_CLIENT."node_over.gif\" />\n";
	$menucode .= "<param name=\"img_node_on\" value=\"".K_PATH_IMAGES_ICONS_CLIENT."node_open.gif\" />\n";
	
	if ($menustyle['menustyle_colbck_off']) {
		$menucode .= "<param name=\"default_colbck_off\" value=\"".substr($menustyle['menustyle_colbck_off'], 1)."\" />\n";
		$menucode .= "<param name=\"connector_bck_col_off\" value=\"".substr($menustyle['menustyle_colbck_off'], 1)."\" />\n";
	}
	if ($menustyle['menustyle_colbck_over']) {
		$menucode .= "<param name=\"default_colbck_over\" value=\"".substr($menustyle['menustyle_colbck_over'], 1)."\" />\n";
		$menucode .= "<param name=\"connector_bck_col_over\" value=\"".substr($menustyle['menustyle_colbck_over'], 1)."\" />\n";
	}
	if ($menustyle['menustyle_colbck_on']) {
		$menucode .= "<param name=\"default_colbck_on\" value=\"".substr($menustyle['menustyle_colbck_on'], 1)."\" />\n";
		$menucode .= "<param name=\"connector_bck_col_on\" value=\"".substr($menustyle['menustyle_colbck_on'], 1)."\" />\n";
	}
	
	if ($menustyle['menustyle_coltxt_off']) {
		$menucode .= "<param name=\"default_coltxt_off\" value=\"".substr($menustyle['menustyle_coltxt_off'], 1)."\" />\n";
		$menucode .= "<param name=\"connector_line_col_off\" value=\"".substr($menustyle['menustyle_coltxt_off'], 1)."\" />\n";
	}
	if ($menustyle['menustyle_coltxt_over']) {
		$menucode .= "<param name=\"default_coltxt_over\" value=\"".substr($menustyle['menustyle_coltxt_over'], 1)."\" />\n";
		$menucode .= "<param name=\"connector_line_col_over\" value=\"".substr($menustyle['menustyle_coltxt_over'], 1)."\" />\n";
	}
	if ($menustyle['menustyle_coltxt_on']) {
		$menucode .= "<param name=\"default_coltxt_on\" value=\"".substr($menustyle['menustyle_coltxt_on'], 1)."\" />\n";
		$menucode .= "<param name=\"connector_line_col_on\" value=\"".substr($menustyle['menustyle_coltxt_on'], 1)."\" />\n";
	}
	
	$menucode .= "<param name=\"connector_line_width\" value=\"1\" />\n";
	$menucode .= "<param name=\"connector_min_width\" value=\"15\" />\n";
	...
	if ($menustyle['menustyle_bck_img_off']>1) {
		$menucode .= "<param name=\"default_bck_img_off\" value=\"".K_PATH_IMAGES_ICONS_CLIENT.F_get_icon_link(K_TABLE_ICONS_CLIENT,$menustyle['menustyle_bck_img_off'])."\" />\n";
		$menucode .= "<param name=\"connector_bck_img_off\" value=\"".K_PATH_IMAGES_ICONS_CLIENT.F_get_icon_link(K_TABLE_ICONS_CLIENT,$menustyle['menustyle_bck_img_off'])."\" />\n";
	}
	if ($menustyle['menustyle_bck_img_over']>1) {
		$menucode .= "<param name=\"default_bck_img_over\" value=\"".K_PATH_IMAGES_ICONS_CLIENT.F_get_icon_link(K_TABLE_ICONS_CLIENT,$menustyle['menustyle_bck_img_over'])."\" />\n";
		$menucode .= "<param name=\"connector_bck_img_over\" value=\"".K_PATH_IMAGES_ICONS_CLIENT.F_get_icon_link(K_TABLE_ICONS_CLIENT,$menustyle['menustyle_bck_img_over'])."\" />\n";
	}
	if ($menustyle['menustyle_bck_img_on']>1) {
		$menucode .= "<param name=\"default_bck_img_on\" value=\"".K_PATH_IMAGES_ICONS_CLIENT.F_get_icon_link(K_TABLE_ICONS_CLIENT,$menustyle['menustyle_bck_img_on'])."\" />\n";
		$menucode .= "<param name=\"connector_bck_img_on\" value=\"".K_PATH_IMAGES_ICONS_CLIENT.F_get_icon_link(K_TABLE_ICONS_CLIENT,$menustyle['menustyle_bck_img_on'])."\" />\n";
	}
	...
	$bindex = F_explore_jwtm_menu_level($menutable, 0, 0);
	...
	if ((K_LANG_ON_MENU) AND (($menutable == K_TABLE_MENU_CLIENT) OR ($menutable == K_TABLE_MENU))) {
		F_display_jwtm_language_button($bindex);
	}
...
// ------------------------------------------------------------
function F_explore_jwtm_menu_level($menutable, $treelevel, $iid) {
	global $l, $db, $selected_language;
	global $menucode, $menualtcode, $popup_position;
	require_once('../../shared/config/cp_extension.inc');
	require_once('../config/cp_config.'.CP_EXT);
		...
		while($m = F_aiocpdb_fetch_array($r)) {
			if (isset($m['menu_enabled']) AND ($m['menu_enabled'])) {
				...
				if(!$m['menu_item']) { //is a node (not the first)
					...
					$menualtcode .= "<ul>";
					$iid = F_explore_jwtm_menu_level($menutable, $m['menu_id'], $iid);
...
// ------------------------------------------------------------
function F_display_jwtm_language_button($iid) {
	global $l, $db, $selected_language;
