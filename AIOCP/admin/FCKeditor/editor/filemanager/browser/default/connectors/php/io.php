...
{
	return RemoveFromEnd( $GLOBALS["UserFilesPath"], '/' ) . $folderPath ; // 2006-03-01 Nicola Asuni [www.aiocp.com]
	/*
	if ( $resourceType == '' )
...
function ServerMapFolder( $resourceType, $folderPath )
{
  ...
  $sResourceTypePath = $GLOBALS["UserFilesDirectory"]; // 2006-03-01 Nicola Asuni [www.aiocp.com]
