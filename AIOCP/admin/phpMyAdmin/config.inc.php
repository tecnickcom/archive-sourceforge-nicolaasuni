 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://localhost/_OPENSOURCE/AIOCP/admin/phpMyAdmin/';
...
$cfg['Servers'][$i]['password']      = 'kmyoxen';          // MySQL password (only needed
...
$cfg['ExecTimeLimit']           = 3600;    // maximum execution time in seconds (0 for no limit)
$cfg['MemoryLimit']             = 536870912;      // maximum allocated bytes (0 for no limit)
...
$cfg['Export']['compression']               = 'zip'; // none/zip/gzip/bzip2
...
$cfg['Export']['sql_structure']             = FALSE;
