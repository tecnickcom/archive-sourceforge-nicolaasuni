<?php
/* ============================================================
 File name   : cp_show_ec_products_xml.php
 Begin       : 2003-11-01
 Last update : 2003-11-01
 Author      : (5) nick
 Description : Display Products in XML format
=============================================================== */
...
echo F_show_products_xml($product_category_id, $product_manufacturer_id, $wherequery, $order_field, $orderdir)
?>
