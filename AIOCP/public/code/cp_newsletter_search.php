<?php
/* ============================================================
 File name   : cp_newsletter_search.php
 Begin       : 2002-04-07 08:30:49
 Last update : 2002-04-07 08:30:49
 Author      : (5) nick
 Description : search in newsletter database
=============================================================== */
...
$page_name = "newsletter_search"; // name of the page (used in DB)
...
F_search_newsletter($wherequery, $order_field, $orderdir, $firstrow, $rowsperpage); 
